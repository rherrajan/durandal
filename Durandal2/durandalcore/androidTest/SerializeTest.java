...
public class SerializeTest {
	...
	public void testTransportMultipleTimes() throws Exception {
		ShortMessage sourceMsg;

		sourceMsg = new ShortMessage(Identifier.build_creep, null);
		Assert.assertEquals(sourceMsg, simulateTransport(sourceMsg));

		sourceMsg = new ShortMessage(Identifier.build_tower, null);
		Assert.assertEquals(sourceMsg, simulateTransport(sourceMsg));
